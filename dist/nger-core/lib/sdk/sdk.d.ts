...
export declare abstract class Sdk {
    ...
    component: any, 
    /** 选项 */
    options: t.CreateIntersectionObserverOption): t.IntersectionObserver;
    abstract createIntersectionObserver(
    /** 选项 */
    options: t.CreateIntersectionObserverOption): IntersectionObserver;
    abstract createLivePlayerContext(
    /** `<live-player/>` 组件的 id */
    id: string, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<live-player/>` 组件 */
    component?: any): t.LivePlayerContext;
    ...
    abstract canvasGetImageData(option: t.CanvasGetImageDataOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    abstract canvasPutImageData(option: t.CanvasPutImageDataOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    abstract canvasToTempFilePath(option: t.CanvasToTempFilePathOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    abstract checkIsSoterEnrolledInDevice(option: t.CheckIsSoterEnrolledInDeviceOption): void;
    abstract checkIsSupportSoterAuthentication(option?: t.CheckIsSupportSoterAuthenticationOption): void;
    ...
    abstract getBLEDeviceCharacteristics(option: t.GetBLEDeviceCharacteristicsOption): void;
    abstract getBLEDeviceServices(option: t.GetBLEDeviceServicesOption): void;
    abstract getBackgroundAudioPlayerState(option?: t.GetBackgroundAudioPlayerStateOption): void;
    ...
    abstract getConnectedBluetoothDevices(option: t.GetConnectedBluetoothDevicesOption): void;
    ...
    abstract notifyBLECharacteristicValueChange(option: t.NotifyBLECharacteristicValueChangeOption): void;
    abstract offAppHide(
    /** 小程序切后台事件的回调函数 */
    callback: t.OffAppHideCallback): void;
    abstract offAppShow(
    /** 小程序切前台事件的回调函数 */
    callback: t.OffAppShowCallback): void;
    abstract offAudioInterruptionBegin(
    /** 音频因为受到系统占用而被中断开始事件的回调函数 */
    callback: t.OffAudioInterruptionBeginCallback): void;
    abstract offAudioInterruptionEnd(
    /** 音频中断结束事件的回调函数 */
    callback: t.OffAudioInterruptionEndCallback): void;
    abstract offError(
    /** 小程序错误事件的回调函数 */
    callback: Function): void;
    abstract offLocalServiceDiscoveryStop(
    /** mDNS 服务停止搜索的事件的回调函数 */
    callback: t.OffLocalServiceDiscoveryStopCallback): void;
    abstract offLocalServiceFound(
    /** mDNS 服务发现的事件的回调函数 */
    callback: t.OffLocalServiceFoundCallback): void;
    abstract offLocalServiceLost(
    /** mDNS 服务离开的事件的回调函数 */
    callback: t.OffLocalServiceLostCallback): void;
    abstract offLocalServiceResolveFail(
    /** mDNS 服务解析失败的事件的回调函数 */
    callback: t.OffLocalServiceResolveFailCallback): void;
    abstract offPageNotFound(
    /** 小程序要打开的页面不存在事件的回调函数 */
    callback: t.OffPageNotFoundCallback): void;
    abstract offWindowResize(
    /** 窗口尺寸变化事件的回调函数 */
    callback: t.OffWindowResizeCallback): void;
    abstract onAccelerometerChange(
    /** 加速度数据事件的回调函数 */
    callback: t.OnAccelerometerChangeCallback): void;
    abstract onAppHide(
    /** 小程序切后台事件的回调函数 */
    callback: t.OnAppHideCallback): void;
    abstract onAppShow(
    /** 小程序切前台事件的回调函数 */
    callback: t.OnAppShowCallback): void;
    abstract onAudioInterruptionBegin(
    /** 音频因为受到系统占用而被中断开始事件的回调函数 */
    callback: t.OnAudioInterruptionBeginCallback): void;
    abstract onAudioInterruptionEnd(
    /** 音频中断结束事件的回调函数 */
    callback: t.OnAudioInterruptionEndCallback): void;
    abstract onBLECharacteristicValueChange(
    /** 低功耗蓝牙设备的特征值变化事件的回调函数 */
    callback: t.OnBLECharacteristicValueChangeCallback): void;
    abstract onBLEConnectionStateChange(
    /** 低功耗蓝牙连接状态的改变事件的回调函数 */
    callback: t.OnBLEConnectionStateChangeCallback): void;
    abstract onBackgroundAudioPause(
    /** 音乐暂停事件的回调函数 */
    callback: t.OnBackgroundAudioPauseCallback): void;
    abstract onBackgroundAudioPlay(
    /** 音乐播放事件的回调函数 */
    callback: t.OnBackgroundAudioPlayCallback): void;
    abstract onBackgroundAudioStop(
    /** 音乐停止事件的回调函数 */
    callback: t.OnBackgroundAudioStopCallback): void;
    abstract onBeaconServiceChange(
    /** iBeacon 服务状态变化事件的回调函数 */
    callback: t.OnBeaconServiceChangeCallback): void;
    abstract onBeaconUpdate(
    /** iBeacon 设备更新事件的回调函数 */
    callback: t.OnBeaconUpdateCallback): void;
    abstract onBluetoothAdapterStateChange(
    /** 蓝牙适配器状态变化事件的回调函数 */
    callback: t.OnBluetoothAdapterStateChangeCallback): void;
    abstract onBluetoothDeviceFound(
    /** 寻找到新设备的事件的回调函数 */
    callback: t.OnBluetoothDeviceFoundCallback): void;
    abstract onCompassChange(
    /** 罗盘数据变化事件的回调函数 */
    callback: t.OnCompassChangeCallback): void;
    abstract onDeviceMotionChange(
    /** 设备方向变化事件的回调函数 */
    callback: t.OnDeviceMotionChangeCallback): void;
    abstract onError(
    /** 小程序错误事件的回调函数 */
    callback: t.OnAppErrorCallback): void;
    abstract onGetWifiList(
    /** 获取到 Wi-Fi 列表数据事件的回调函数 */
    callback: t.OnGetWifiListCallback): void;
    abstract onGyroscopeChange(
    /** 陀螺仪数据变化事件的回调函数 */
    callback: t.OnGyroscopeChangeCallback): void;
    abstract onHCEMessage(
    /** 接收 NFC 设备消息事件的回调函数 */
    callback: t.OnHCEMessageCallback): void;
    abstract onLocalServiceDiscoveryStop(
    /** mDNS 服务停止搜索的事件的回调函数 */
    callback: t.OnLocalServiceDiscoveryStopCallback): void;
    abstract onLocalServiceFound(
    /** mDNS 服务发现的事件的回调函数 */
    callback: t.OnLocalServiceFoundCallback): void;
    abstract onLocalServiceLost(
    /** mDNS 服务离开的事件的回调函数 */
    callback: t.OnLocalServiceLostCallback): void;
    abstract onLocalServiceResolveFail(
    /** mDNS 服务解析失败的事件的回调函数 */
    callback: t.OnLocalServiceResolveFailCallback): void;
    abstract onMemoryWarning(
    /** 内存不足告警事件的回调函数 */
    callback: t.OnMemoryWarningCallback): void;
    abstract onNetworkStatusChange(
    /** 网络状态变化事件的回调函数 */
    callback: t.OnNetworkStatusChangeCallback): void;
    abstract onPageNotFound(
    /** 小程序要打开的页面不存在事件的回调函数 */
    callback: t.OnPageNotFoundCallback): void;
    abstract onSocketClose(
    /** WebSocket 连接关闭事件的回调函数 */
    callback: t.OnSocketCloseCallback): void;
    abstract onSocketError(
    /** WebSocket 错误事件的回调函数 */
    callback: t.OnSocketErrorCallback): void;
    abstract onSocketMessage(
    /** WebSocket 接受到服务器的消息事件的回调函数 */
    callback: t.OnSocketMessageCallback): void;
    abstract onSocketOpen(
    /** WebSocket 连接打开事件的回调函数 */
    callback: t.OnSocketOpenCallback): void;
    abstract onUserCaptureScreen(
    /** 用户主动截屏事件的回调函数 */
    callback: t.OnUserCaptureScreenCallback): void;
    abstract onWifiConnected(
    /** 连接上 Wi-Fi 的事件的回调函数 */
    callback: t.OnWifiConnectedCallback): void;
    abstract onWindowResize(
    /** 窗口尺寸变化事件的回调函数 */
    callback: t.OnWindowResizeCallback): void;
    ...
    abstract startBluetoothDevicesDiscovery(option: t.StartBluetoothDevicesDiscoveryOption): void;
    ...
    abstract stopBluetoothDevicesDiscovery(option?: t.StopBluetoothDevicesDiscoveryOption): void;
    ...
    abstract writeBLECharacteristicValue(option: t.WriteBLECharacteristicValueOption): void;
    abstract clearInterval(intervalID: number): void;
