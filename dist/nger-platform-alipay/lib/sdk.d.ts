...
export declare class AlipaySdk extends Sdk {
    ...
    canvasGetImageData(option: t.CanvasGetImageDataOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    canvasPutImageData(option: t.CanvasPutImageDataOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    canvasToTempFilePath(option: t.CanvasToTempFilePathOption, 
    /** 在自定义组件下，当前组件实例的this，以操作组件内 `<canvas/>` 组件 */
    component?: any): void;
    checkIsSoterEnrolledInDevice(option: t.CheckIsSoterEnrolledInDeviceOption): void;
    checkIsSupportSoterAuthentication(option?: t.CheckIsSupportSoterAuthenticationOption): void;
    ...
    getBLEDeviceCharacteristics(option: t.GetBLEDeviceCharacteristicsOption): void;
    getBLEDeviceServices(option: t.GetBLEDeviceServicesOption): void;
    getBackgroundAudioPlayerState(option?: t.GetBackgroundAudioPlayerStateOption): void;
    ...
    getConnectedBluetoothDevices(option: t.GetConnectedBluetoothDevicesOption): void;
    ...
    notifyBLECharacteristicValueChange(option: t.NotifyBLECharacteristicValueChangeOption): void;
    offAppHide(
    /** 小程序切后台事件的回调函数 */
    ...
    startBluetoothDevicesDiscovery(option: t.StartBluetoothDevicesDiscoveryOption): void;
    ...
    stopBluetoothDevicesDiscovery(option?: t.StopBluetoothDevicesDiscoveryOption): void;
    ...
    writeBLECharacteristicValue(option: t.WriteBLECharacteristicValueOption): void;
