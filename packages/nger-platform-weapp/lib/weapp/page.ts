...
export interface PageInstanceBaseProps<D extends IAnyObject = any> {
    /** 页面的初始数据
     * 
...
export interface PageInstance<D extends IAnyObject = any, T extends IAnyObject = any> extends PageInstanceBaseProps<D> {
    /** 生命周期回调—监听页面加载
     *
...
export interface GetCurrentPages {
